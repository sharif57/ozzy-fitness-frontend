        ...
        <div>
          <div className="flex items-center  w-5/6 mx-auto bg-white/10 backdrop-blur-lg rounded-lg px- ">
            ...
            <button
              ...
              className="bg-[#01336F] text-white lg:px-8 px-4 lg:py-6 py-6 rounded-r-lg flex items-center justify-center"
            >
              {isLoading ? (
                <div className="w-6 h-6 border-4 border-t-4 border-white border-solid rounded-full animate-spin"><LoaderIcon></LoaderIcon></div> // Spinner inside button
              ) : (
                "Enter"
              )}
            </button>
