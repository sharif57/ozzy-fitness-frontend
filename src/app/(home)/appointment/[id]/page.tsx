...
// import { usePaymentDataQuery } from "@/redux/features/paymentSlice";
...
const AppointmentBooking: React.FC = () => {
  ...
  const { data: paymentData } = usePaymentDataQuery(undefined)
  console.log(paymentData?.appointmentId)
  ...
  const handleBooking = async (values: any) => {
    ...
    try {
      ...
      if (response.url) {
        ...
        Modal.error({
          title: "Payment Error",
          content: "No payment URL provided. Please contact support.",
        });
      }
