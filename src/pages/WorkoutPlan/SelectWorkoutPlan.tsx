...
const SelectWorkoutPlan: React.FC = () => {
  ...
  const plans: WorkoutPlans[] = [
    ...
    },
    {
      ...
      time: "4 Week",
      description:
        "Exercise-Induced Asthma – Shortness of breath triggered by strenuous activity.",
    ...
    },
    {
      ...
      time: "4 Week",
      description:
        "Amenorrhea (Missed Periods) – Overtraining can disrupt menstrual cycles in women.",
