      ...
      <div className="container mx-auto lg:p-6 p-2 rounded-lg">
        ...
        <div className="p-4 flex justify-end gap-4">
          <button
            ...
            className="py-2 text-[18px] font-normal px-8 border border-black rounded-lg text-gray-700 hover:bg-gray-100 transition w-[140px] h-[48px] flex items-center justify-center"
          >
            Previous
          </button>
          <button
            onClick={handleNext}
            className="py-2 text-[18px] font-normal px-8 bg-[#01336F] text-white rounded-lg transition w-[140px] h-[48px] flex items-center justify-center"
          >
            Next
          </button>
        </div>
